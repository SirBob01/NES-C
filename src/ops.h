...
static const opcode_t OP_TABLE[0x100] = {
    ...
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ORA, ADDR_ZERO_PAGE, 3},
    {OP_ASL, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_PHP, ADDR_IMPLIED, 3},     {OP_ORA, ADDR_IMMEDIATE, 2},
    {OP_ASL, ADDR_ACCUMULATOR, 2}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ORA, ADDR_ABSOLUTE, 4},
    {OP_ASL, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BPL, ADDR_RELATIVE, 2},    {OP_ORA, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ORA, ADDR_ZERO_PAGE_X, 4},
    {OP_ASL, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CLC, ADDR_IMPLIED, 2},     {OP_ORA, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ORA, ADDR_ABSOLUTE_X, 4},
    {OP_ASL, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_JSR, ADDR_ABSOLUTE, 6},    {OP_AND, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BIT, ADDR_ZERO_PAGE, 3},   {OP_AND, ADDR_ZERO_PAGE, 3},
    {OP_ROL, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_PLP, ADDR_IMPLIED, 4},     {OP_AND, ADDR_IMMEDIATE, 2},
    {OP_ROL, ADDR_ACCUMULATOR, 2}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BIT, ADDR_ABSOLUTE, 4},    {OP_AND, ADDR_ABSOLUTE, 4},
    {OP_ROL, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BMI, ADDR_RELATIVE, 2},    {OP_AND, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_AND, ADDR_ZERO_PAGE_X, 4},
    {OP_ROL, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_SEC, ADDR_IMPLIED, 2},     {OP_AND, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_AND, ADDR_ABSOLUTE_X, 4},
    {OP_ROL, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_RTI, ADDR_IMPLIED, 6},     {OP_EOR, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_EOR, ADDR_ZERO_PAGE, 3},
    {OP_LSR, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_PHA, ADDR_IMPLIED, 3},     {OP_EOR, ADDR_IMMEDIATE, 2},
    {OP_LSR, ADDR_ACCUMULATOR, 2}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_JMP, ADDR_ABSOLUTE, 3},    {OP_EOR, ADDR_ABSOLUTE, 4},
    {OP_LSR, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BVC, ADDR_RELATIVE, 2},    {OP_EOR, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_EOR, ADDR_ZERO_PAGE_X, 4},
    {OP_LSR, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CLI, ADDR_IMPLIED, 2},     {OP_EOR, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_EOR, ADDR_ABSOLUTE_X, 4},
    {OP_LSR, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_RTS, ADDR_IMPLIED, 6},     {OP_ADC, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ADC, ADDR_ZERO_PAGE, 3},
    {OP_ROR, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_PLA, ADDR_IMPLIED, 4},     {OP_ADC, ADDR_IMMEDIATE, 2},
    {OP_ROR, ADDR_ACCUMULATOR, 2}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_JMP, ADDR_INDIRECT, 5},    {OP_ADC, ADDR_ABSOLUTE, 4},
    {OP_ROR, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BVS, ADDR_RELATIVE, 2},    {OP_ADC, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ADC, ADDR_ZERO_PAGE_X, 4},
    {OP_ROR, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_SEI, ADDR_IMPLIED, 2},     {OP_ADC, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_ADC, ADDR_ABSOLUTE_X, 4},
    {OP_ROR, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 2},     {OP_STA, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_STY, ADDR_ZERO_PAGE, 3},   {OP_STA, ADDR_ZERO_PAGE, 3},
    {OP_STX, ADDR_ZERO_PAGE, 3},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_DEY, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_TXA, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_STY, ADDR_ABSOLUTE, 4},    {OP_STA, ADDR_ABSOLUTE, 4},
    {OP_STX, ADDR_ABSOLUTE, 4},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BCC, ADDR_RELATIVE, 2},    {OP_STA, ADDR_INDIRECT_Y, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_STY, ADDR_ZERO_PAGE_X, 4}, {OP_STA, ADDR_ZERO_PAGE_X, 4},
    {OP_STX, ADDR_ZERO_PAGE_Y, 4}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_TYA, ADDR_IMPLIED, 2},     {OP_STA, ADDR_ABSOLUTE_Y, 5},
    {OP_TXS, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_STA, ADDR_ABSOLUTE_X, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_LDY, ADDR_IMMEDIATE, 2},   {OP_LDA, ADDR_INDIRECT_X, 6},
    {OP_LDX, ADDR_IMMEDIATE, 2},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_LDY, ADDR_ZERO_PAGE, 3},   {OP_LDA, ADDR_ZERO_PAGE, 3},
    {OP_LDX, ADDR_ZERO_PAGE, 3},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_TAY, ADDR_IMPLIED, 2},     {OP_LDA, ADDR_IMMEDIATE, 2},
    {OP_TAX, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_LDY, ADDR_ABSOLUTE, 4},    {OP_LDA, ADDR_ABSOLUTE, 4},
    {OP_LDX, ADDR_ABSOLUTE, 4},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BCS, ADDR_RELATIVE, 2},    {OP_LDA, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_LDY, ADDR_ZERO_PAGE_X, 4}, {OP_LDA, ADDR_ZERO_PAGE_X, 4},
    {OP_LDX, ADDR_ZERO_PAGE_Y, 4}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CLV, ADDR_IMPLIED, 2},     {OP_LDA, ADDR_ABSOLUTE_Y, 4},
    {OP_TSX, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_LDY, ADDR_ABSOLUTE_X, 4},  {OP_LDA, ADDR_ABSOLUTE_X, 4},
    {OP_LDX, ADDR_ABSOLUTE_Y, 4},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CPY, ADDR_IMMEDIATE, 2},   {OP_CMP, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CPY, ADDR_ZERO_PAGE, 3},   {OP_CMP, ADDR_ZERO_PAGE, 3},
    {OP_DEC, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    {OP_INY, ADDR_IMPLIED, 2},     {OP_CMP, ADDR_IMMEDIATE, 2},
    {OP_DEX, ADDR_IMPLIED, 2},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CPY, ADDR_ABSOLUTE, 4},    {OP_CMP, ADDR_ABSOLUTE, 4},
    {OP_DEC, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BNE, ADDR_RELATIVE, 2},    {OP_CMP, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_CMP, ADDR_ZERO_PAGE_X, 4},
    {OP_DEC, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CLD, ADDR_IMPLIED, 2},     {OP_CMP, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_CMP, ADDR_ABSOLUTE_X, 4},
    {OP_DEC, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CPX, ADDR_IMMEDIATE, 2},   {OP_SBC, ADDR_INDIRECT_X, 6},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_CPX, ADDR_ZERO_PAGE, 3},   {OP_SBC, ADDR_ZERO_PAGE, 3},
    {OP_INC, ADDR_ZERO_PAGE, 5},   {OP_NOP, ADDR_IMPLIED, 0},
    ...
    {OP_INC, ADDR_ABSOLUTE, 6},    {OP_NOP, ADDR_IMPLIED, 0},
    {OP_BEQ, ADDR_RELATIVE, 2},    {OP_SBC, ADDR_INDIRECT_Y, 5},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_SBC, ADDR_ZERO_PAGE_X, 4},
    {OP_INC, ADDR_ZERO_PAGE_X, 6}, {OP_NOP, ADDR_IMPLIED, 0},
    {OP_SED, ADDR_IMPLIED, 2},     {OP_SBC, ADDR_ABSOLUTE_Y, 4},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_NOP, ADDR_IMPLIED, 0},
    {OP_NOP, ADDR_IMPLIED, 0},     {OP_SBC, ADDR_ABSOLUTE_X, 4},
    {OP_INC, ADDR_ABSOLUTE_X, 7},  {OP_NOP, ADDR_IMPLIED, 0},
};
